import{c as i,r,u as b,j as e,L as S,B as j}from"./index-Cu1Qx7aY.js";import{U as h,B as C,a as y,S as M}from"./utensils-BNedX1bF.js";import{C as E}from"./credit-card-7K4Rl4ky.js";import{B as H}from"./bell-xs_6nLTK.js";/**
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const R=i("ClipboardCheck",[["rect",{width:"8",height:"4",x:"8",y:"2",rx:"1",ry:"1",key:"tgr4d6"}],["path",{d:"M16 4h2a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V6a2 2 0 0 1 2-2h2",key:"116196"}],["path",{d:"m9 14 2 2 4-4",key:"df797q"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const v=i("LayoutGrid",[["rect",{width:"7",height:"7",x:"3",y:"3",rx:"1",key:"1g98yp"}],["rect",{width:"7",height:"7",x:"14",y:"3",rx:"1",key:"6d4xhi"}],["rect",{width:"7",height:"7",x:"14",y:"14",rx:"1",key:"nxv5o0"}],["rect",{width:"7",height:"7",x:"3",y:"14",rx:"1",key:"1bb6yr"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const A=i("Mail",[["rect",{width:"20",height:"16",x:"2",y:"4",rx:"2",key:"18n3k1"}],["path",{d:"m22 7-8.97 5.7a1.94 1.94 0 0 1-2.06 0L2 7",key:"1ocrg3"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const z=i("MapPin",[["path",{d:"M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z",key:"2oe9fu"}],["circle",{cx:"12",cy:"10",r:"3",key:"ilqhr7"}]]);/**
 * @license lucide-react v0.383.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 */const U=i("X",[["path",{d:"M18 6 6 18",key:"1bl5f8"}],["path",{d:"m6 6 12 12",key:"d8bk6v"}]]),g=[{label:"Home",href:"/"},{label:"About",href:"/about"},{label:"Contact Us",href:"/#contactUs"},{label:"Announcements",href:"/#announcements"}];function B({activeLink:a="Home"}){const[n,l]=r.useState(!1),o=b();return e.jsxs("header",{className:"sticky top-0 z-50 bg-[#000080]/95 backdrop-blur-md border-b border-blue-800 shadow-lg transition-all duration-500",children:[e.jsx("div",{className:"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8",children:e.jsxs("div",{className:"flex items-center justify-between h-20",children:[e.jsxs(S,{to:"/",className:"flex items-center gap-3 group transition-all duration-300",children:[e.jsx("span",{className:"flex items-center justify-center w-11 h-11 rounded-xl bg-[#d4af37] text-[#00008B] shadow-md transition-all duration-300 group-hover:rotate-6 group-hover:scale-110",children:e.jsx(j,{size:22})}),e.jsx("span",{className:"font-bold text-lg tracking-wide text-white transition-colors duration-300 group-hover:text-[#d4af37]",children:"UniNest"})]}),e.jsx("nav",{className:"hidden md:flex items-center gap-10",children:g.map(s=>e.jsx("a",{href:s.href,className:`relative text-sm font-semibold transition-all duration-300 hover:scale-105
        ...
        `,children:[e.jsxs("div",{className:"text-center sm:text-left",children:[e.jsxs("div",{className:"flex items-center justify-center sm:justify-start gap-2 mb-4",children:[e.jsx("span",{className:"flex items-center justify-center w-9 h-9 rounded-lg bg-white/10",children:e.jsx(j,{size:20,className:"text-white"})}),e.jsx("span",{className:"font-semibold text-lg text-white",children:"UniNest"})]}),e.jsx("p",{className:"text-sm text-slate-400 leading-relaxed max-w-xs mx-auto sm:mx-0",children:"One Platform. Complete Hostel Management."})]}),e.jsxs("div",{className:"text-center sm:text-left",children:[e.jsx("h4",{className:"text-white font-semibold mb-4",children:"Quick Links"}),e.jsx("ul",{className:"space-y-3 text-sm",children:I.map(a=>e.jsx("li",{children:e.jsx("a",{href:a.href,className:"hover:text-white transition-colors",children:a.label})},a.label))})]}),e.jsxs("div",{className:"text-center sm:text-left",children:[e.jsx("h4",{className:"text-white font-semibold mb-4",children:"Contact Us"}),e.jsxs("ul",{className:"space-y-4 text-sm",children:[e.jsxs("li",{className:`\r
                ...
                gap-2 \r
                sm:gap-3\r
              `,children:[e.jsx(z,{size:17,className:"shrink-0 text-slate-400 mt-1"}),e.jsx("span",{className:"leading-relaxed",children:"Department of Computer Science, Faculty of Science, University of Ruhuna."})]}),e.jsxs("li",{className:`\r
                flex \r
                items-center \r
                justify-center \r
                sm:justify-start \r
                gap-3\r
              `,children:[e.jsx(L,{size:16,className:"shrink-0 text-slate-400"}),e.jsx("span",{children:"+94 11 223 4455"})]}),e.jsxs("li",{className:`\r
                flex \r
                items-center \r
                justify-center \r
                sm:justify-start \r
                gap-3\r
              `,children:[e.jsx(A,{size:16,className:"shrink-0 text-slate-400"}),e.jsx("span",{className:"break-all",children:"uninest@gmail.com"})]})]})]})]})}),e.jsx("div",{className:"border-t border-white/10",children:e.jsx("div",{className:`\r
          max-w-7xl \r
          mx-auto \r
          px-5 \r
          sm:px-6 \r
