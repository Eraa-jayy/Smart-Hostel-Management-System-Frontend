  ...
  return (
    <footer className="bg-[#000080] text-slate-300">
          ...
          <div className="text-center sm:text-left">
            ...
            <ul className="space-y-4 text-sm">
              <li className="flex flex-col sm:flex-row items-center sm:items-start gap-2 sm:gap-3">
                <MapPin size={17} className="shrink-0 text-slate-400 mt-1" />
              ...
              <li className="flex items-center justify-center sm:justify-start gap-3">
                ...
                <span className="break-all">uninest@gmail.com</span>
              </li>
            </ul>
          </div>
        </div>
      ...
      <div className="border-t border-white/10">
        <div className="max-w-7xl mx-auto px-5 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-center gap-2 text-center text-xs text-slate-500">
          <p>
